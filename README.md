...
1. 플러그인을 설치합니다.
   ...
   # 플러그인 설치
   /plugin marketplace add SunhSOO/sunhsoo-codereview-harness
...
- Claude Code판은 `plugin/commands/*.md` 기반의 slash command 플러그인입니다.
- Codex판은 `plugins/sunhsoo-codereview/skills/*/SKILL.md` 기반의 skill 플러그인입니다.
